...
public class StoreManagerController {
    ...
    public RfqPayloadDto updateRfq(@RequestBody RfqPayloadDto payloadDto){
        ctx.requireRole("MANAGER");
        return rfqService.updateRfq(payloadDto);
    }
    ...
    public RfqPayloadDto getRfqsById(@PathVariable Integer rfqId) {
        ctx.requireRole("MANAGER");
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void awardRfq(@RequestBody BidDto bidDto, @RequestParam String status
    ) {
        ctx.requireRole("MANAGER");
        rfqService.award(bidDto, status);
    }
